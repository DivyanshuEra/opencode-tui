...
[![Visual Studio Marketplace](https://img.shields.io/visual-studio-marketplace/v/divyanshuera.opencode-tui?logo=visual-studio-code&label=VS%20Code%20Marketplace)](https://marketplace.visualstudio.com/items?itemName=divyanshuera.opencode-tui)
[![Open VSX](https://img.shields.io/open-vsx/v/divyanshuera/opencode-tui?logo=open-vsx&label=Open%20VSX)](https://open-vsx.org/extension/divyanshuera/opencode-tui)
[![GitHub Sponsors](https://img.shields.io/badge/Sponsor-GitHub-pink?logo=githubsponsors)](https://github.com/sponsors/divyanshuera)

The ultimate sidebar terminal console and multiplexer manager built by Divyanshu Era.

If this project helps your workflow, you can [support it on GitHub Sponsors](https://github.com/sponsors/divyanshuera).
...
Or visit the [OpenVSX page](https://open-vsx.org/extension/divyanshuera/opencode-tui).
...
```bash
git clone https://github.com/divyanshuera/opencode-tui.git
cd opencode-tui
```
...
<a href="https://star-history.com/#divyanshuera/opencode-tui&Date">
 <picture>
   <source media="(prefers-color-scheme: dark)" srcset="https://api.star-history.com/svg?repos=divyanshuera/opencode-tui&type=Date&theme=dark" />
   <source media="(prefers-color-scheme: light)" srcset="https://api.star-history.com/svg?repos=divyanshuera/opencode-tui&type=Date" />
   <img alt="Star History Chart" src="https://api.star-history.com/svg?repos=divyanshuera/opencode-tui&type=Date" />
 </picture>
</a>
