  ...
  implements vscode.WebviewViewProvider, vscode.WebviewPanelSerializer
{
  ...
  public static readonly panelViewType = "opencode-tui.terminalEditor";
  ...
  public closeTerminal(): void {
    this.sessionRuntime.destroySession("default");
    this.postWebviewMessage({ type: "terminalExited" });
  ...
  private async revealSidebarView(): Promise<void> {
    try {
      await vscode.commands.executeCommand(
        "workbench.view.extension.divyanshuEraContainer",
      );
    } catch {
